...
if __name__ == '__main__':
   ...
   parser.add_argument('--model', default="shufflenet_1x_g3_deploy.prototxt", help="The net definition prototxt")
   parser.add_argument('--weights', default="shufflenet_1x_g3.caffemodel", help="The weights caffemodel")
